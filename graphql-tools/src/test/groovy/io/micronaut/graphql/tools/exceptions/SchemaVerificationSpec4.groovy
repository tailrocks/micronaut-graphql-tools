...
"""
  ...
  Mapped class: ${SchemaVerificationSpec4.Query1.name}
  Mapped method: username(${String.name} uid)"""
            ...
            e.cause.mappingDetails.mappedClass == SchemaVerificationSpec4.Query1
  ...
  GraphQL type: Query
  GraphQL field: username
  Mapped class: ${SchemaVerificationSpec4.Query2.name}
  Mapped method: username(${String.name} uid, ${DataFetchingEnvironment.name} dfe)"""
            e.cause.mappingDetails.graphQlType == 'Query'
            e.cause.mappingDetails.graphQlField == 'username'
            e.cause.mappingDetails.mappedClass == SchemaVerificationSpec4.Query2
